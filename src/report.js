...
</style><style>.topbar-actions{display:flex;align-items:center;gap:10px}.refresh-button{border:1px solid var(--primary);background:#fff;color:var(--primary);border-radius:9px;padding:7px 11px;font:inherit;font-weight:700;cursor:pointer}.refresh-button:hover{background:var(--primary-soft)}.refresh-button:focus-visible{outline:2px solid var(--primary);outline-offset:2px}</style></head><body><main class="shell">
<nav class="topbar"><span class="brand">QDII Monitor</span><div class="topbar-actions"><span class="updated">更新于 ${escapeHtml(observed)}</span><button id="refresh-page" class="refresh-button" type="button" aria-label="刷新页面数据">↻ 刷新</button></div></nav>
